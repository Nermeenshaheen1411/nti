pipeline {
    ...
    environment {
        DOCKER_IMAGE_NAME = "diango"  // Replace spaces with underscores or remove spaces
        ECR_REPO_URL = "533267335018.dkr.ecr.us-east-2.amazonaws.com/ecr-repo"  // Update with your ECR repository URL
